...
console.log(evt.target)
  ...
  const editExistingMember = () => {
    ...
    // const { fname, lname, bio } = values
    // const editMember = { fname, lname, bio, id: editing }
      ...
      <div id="membersForm">
        ...
        <form onSubmit={evt => onSubmit(evt)}>
          <div>
            ...
            <input id="fname" type="text" placeholder="Type First Name" value={values.fname} onChange={evt => onChange(evt)}/>
          </div>

          <div>
            <label htmlFor="lname">Last Name </label>
            <input id="lname" type="text" placeholder="Type Last Name" value={values.lname} onChange={evt => onChange(evt)}/>
          </div>

          <div>
            <label htmlFor="bio">Bio </label>
            <textarea id="bio" placeholder="Type Bio" value={values.bio} onChange={evt => onChange(evt)}/>
          </div>
